...
const artists = [
  {
    id: 1,
    name: "Sophia Nguyen",
    photoUrl: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80",
          ...
          {artists.map((artist) => (
            ...
            >
              <div className="p-6 text-center">
                ...
                <h3 className="font-playfair font-bold text-xl mb-1">{artist.name}</h3>
              ...
              <div className="bg-gradient-to-r from-pastel-pink to-pastel-purple p-4 text-center">
                <a href="#" className="text-gray-800 font-medium hover:underline flex items-center justify-center">
                  View Artist Profile 
