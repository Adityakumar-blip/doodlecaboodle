          ...
          <div className="absolute inset-0 flex flex-col justify-center px-8 md:px-16 lg:px-24 z-20">
            <div className="max-w-2xl">
              ...
              <div className="flex items-center gap-4">
                ...
                <button className="px-6 py-3 text-sm font-medium text-white hover:text-black border border-white bg-transparent rounded-md hover:bg-white/90 transition-colors">
                  Meet the artists
                </button>
              </div>
            </div>
