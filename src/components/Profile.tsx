...
const UserProfile = () => {
  ...
  const [user, setUser] = useState({
    ...
    avatar:
      "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
    bio: "Art enthusiast and collector with a passion for contemporary paintings and mixed media pieces.",
    address: "123 Art Avenue, Creative City, CA 90210",
    preferences: {
    ...
    setUser({
      ...
      preferences: {
        ...
        notificationPreferences: {
          ...
          [type]: !user.preferences.notificationPreferences[type],
        },
      },
    });
  };
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mb-3">
                        {user.preferences.favoriteMediums.map((medium, idx) => (
                          <span
                            key={idx}
                      ...
                      <p className="text-sm text-gray-600">
                        Preferred price range: {user.preferences.priceRange}
                      </p>
                    </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      checked={user.preferences.notificationPreferences.app}
        ...
        <div className="col-span-1 lg:col-span-3 mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {[1, 2, 3, 4].map((item) => (
              ...
              >
                <img
                  src={`https://images.unsplash.com/photo-165811741${
                    item * 10000 + 123
                  }-b6scj2RwUOM?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3`}
                  alt={`Artwork ${item}`}
