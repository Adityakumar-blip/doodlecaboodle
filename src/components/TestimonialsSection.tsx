...
const testimonials = [
  {
    quote:
      "Being featured in Doodle caboodle has transformed my career. The exposure and care they give to artists is unparalleled.",
    author: "Emma Winters",
  ...
  {
    quote:
      "I've purchased several pieces from Doodle caboodle and each one has brought joy and inspiration to my home. Their curation is exceptional.",
    author: "Michael Chen",
    role: "Collector",
    image:
  ...
  {
    quote:
      "The team at Doodle caboodle understands artists' needs and provides a beautiful platform to showcase our work to the world.",
